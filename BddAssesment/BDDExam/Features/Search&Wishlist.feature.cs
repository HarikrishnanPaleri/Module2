...
namespace BDDExam.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("Search&Wishlist")]
    public partial class SearchWishlistFeature
    {
...
#line 1 "Search&Wishlist.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Search&Wishlist", "A short summary of the feature", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.CategoryAttribute("E2E-Search_AddtoWishlist")]
        [NUnit.Framework.TestCaseAttribute("Bag", "2", null)]
...
#line hidden
#line 10
 testRunner.When(string.Format("User select the \'{0}\'", productno), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 11
 testRunner.Then(string.Format("Product page \'{0}\' is loaded", searchtext), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 12
 testRunner.When("User Clicks the Add To Wishlist button", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 13
    testRunner.Then(string.Format("Product \'{0}\' added to wishlist", searchtext), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
