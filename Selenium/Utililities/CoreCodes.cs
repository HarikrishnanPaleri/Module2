...
namespace SeleniumAssesment.Utililities
{
    internal class CoreCodes
    {
...

        {
            ...
            WebDriverWait Webwait = new WebDriverWait(driver, TimeSpan.FromSeconds(10));
            Webwait.Until(driver => (bool)js.ExecuteScript("return arguments[0].complete", element));
        }
